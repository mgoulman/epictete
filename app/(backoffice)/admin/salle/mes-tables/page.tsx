...
function ReserveModal({ table, onClose, onSaved }: { table: Table; onClose: () => void; onSaved: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div className="bg-card border border-border rounded-2xl w-full max-w-sm max-h-[90vh] overflow-y-auto p-6 shadow-[var(--shadow-sm)]" onClick={e => e.stopPropagation()}>
...
function OrderModal({ table, staffId, onClose, onChanged }: { table: Table; staffId: string | null; onClose: () => void; onChanged: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div className="bg-card border border-border rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 shadow-[var(--shadow-sm)]" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
